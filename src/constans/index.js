import { aflacLogo, android, angular, cognizantLogo,
     facebook, firebase, instagram, ionic, linkdin, mysql,
      nodejs,
      react, typescript, wellsLogo, wiuLogo, youtube } from "../assets/images"
...
export const AppText={
    ...
    about: "About",
    me:"Me",
    desc:"I am Hilal Hamdi and I worked as Frontend Web Developer and Currently I am a Software Architecture",
    aboutMeDescripion:'I am software developer working in IT industry from  last 4 Years as Full stack developer. Expert in UI/UX design, Front-end  and Back-end Development',
    Skills:'Skills & ',
    Experties:'Experties',
    ...
    Contact:'Contact ',
    Us:'Us',
    copywriteText:'Copyright by Hilal Bow @2025'
...
export const workDetail=[
    { 
        id:1,
        year:'2025',
        compnayName:'Pt. Bumi Mineral Sulawesi',
        position:'Lead Software Developer'
    },
    { 
        id:1,
        year:'2024',
        compnayName:'Rumah Web Indonesia',
        position:'Full Stack Developer'
    },
    { 
        id:1,
        year:'2022',
        compnayName:'Beranda Informatika',
        position:'Full Stack Developer'
    },
    { 
        id:1,
        year:'2020',
        compnayName:'Coding Studio',
